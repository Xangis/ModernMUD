...
namespace ModernMUD
{
    ...
    public class BitvectorFlagType
    {
        ...
        public static BitvectorFlagType[] AffectFlags = 
        {
            ...
            new BitvectorFlagType( "flaming", Affect.AFFECT_FLAMING, true),
            ...
            new BitvectorFlagType( "ghoul", Affect.AFFECT_GHOUL, true),
            new BitvectorFlagType( "gills", Affect.AFFECT_GILLS, true),
            ...
            new BitvectorFlagType( "inertial", Affect.AFFECT_INFRARED, true),
            new BitvectorFlagType( "infrared", Affect.AFFECT_INERTIAL_BARRIER, true),
            new BitvectorFlagType( "infrared", Affect.AFFECT_INFRARED, true),
            ...
            new BitvectorFlagType( "ko", Affect.AFFECT_KO, true),
            ...
            new BitvectorFlagType( "plague", Affect.AFFECT_PLAGUE, true),
            ...
            new BitvectorFlagType( "shadow form", Affect.AFFECT_SHADOW, true),
            ...
            new BitvectorFlagType( "underdarkvis", Affect.AFFECT_UNDERDARK_VIS, true),
